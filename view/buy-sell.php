      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-5 col-lg-12 col-md-12">
            ...
            <p class="p-4">ВНИМАНИЕ: Перед импортом сделайте экспорт текущих данных. После ипорта старые данные удаляются без возврата!</p>
          </div>
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      <tbody>
                        ...
                        <tr>
                          <td>Транзакции</td>
                          <td><?=DBC::count('history', array('uid'=>$_SESSION['user']['id']))?> совершено</td>
                        </tr>
                        <tr>
                          <td>Приходы</td>
                          <td>
